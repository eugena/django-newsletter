...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscription.activation_code'
        db.delete_column(u'newsletter_subscription', 'activation_code')


    def backwards(self, orm):
        # Adding field 'Subscription.activation_code'
        db.add_column(u'newsletter_subscription', 'activation_code',
                      self.gf('django.db.models.fields.CharField')(default='807648dd440ba29b6c2418e3cba79d5bc706b403', max_length=40),
                      keep_default=False)
    ...
    models = {
        ...
        u'newsletter.article': {
            ...
            'sortorder': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        u'newsletter.submission': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['newsletter.Message']"}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['newsletter.Newsletter']"}),
